...
parser.add_argument('--feature_path', type=str, default='500_feats_C3D_69_stride_16_val_2.hdf5', help='feature data path')
parser.add_argument('--short_ratio', type=int, default=4, help='short ratio')
parser.add_argument('--output_feature_path', type=str, default='500_feats_C3D_69_stride_16_64_val_2.hdf5', help='output feature data path')
...
for vid in features.keys():
    ...
    new_len = int(feat.shape[0]/short_ratio)
    short_feat = []
...
for vid in out_features.keys():
    if vid in fid:
        ...
        continue
    feats_dict = {
        vid: out_features[vid],
    }

    for k, v in feats_dict.items():
        fid.create_dataset(k, data=v)
