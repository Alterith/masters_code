...
class C3D_ATTN_16_Architecture(nn.Module):
    ...
    def __init__(self, num_classes=368) -> None:
        ...
        Raises:
            None
        """
        super(C3D_ATTN_16_Architecture,self).__init__()
        ...
        self.attn1 = LinearAttentionBlock3D(in_features=256, t_depth=8, normalize_attn=True)
        self.attn2 = LinearAttentionBlock3D(in_features=512, t_depth=4, normalize_attn=True)
        self.attn3 = LinearAttentionBlock3D(in_features=512, t_depth=2, normalize_attn=True)
